# ----------------------------py-sidebot--------------------------------------------------------
# This is a demonstration of using an LLM to enhance a data dashboard written in Python Shiny. 
# https://github.com/jcheng5/py-sidebot/tree/main
...
def server(input, output, session):
    ...
    async def perform_chat():
        with reactive.isolate():
            ...
            # use below if stream=False
            await chat.append_message(response)
            # use below if stream=True
